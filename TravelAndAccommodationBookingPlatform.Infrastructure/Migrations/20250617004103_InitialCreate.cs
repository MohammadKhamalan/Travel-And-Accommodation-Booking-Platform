        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoomCategory = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoomTypesRoomTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AmenityRoomType", x => new { x.AmenitiesId, x.RoomTypesRoomTypeId });
                    table.ForeignKey(
                        name: "FK_AmenityRoomType_RoomAmenities_AmenitiesId",
                        column: x => x.AmenitiesId,
                        principalTable: "RoomAmenities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AmenityRoomType_RoomTypes_RoomTypesRoomTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Booking_CheckInDate", "CheckInDate >= GETDATE()");
                    table.CheckConstraint("CK_Booking_CheckOutDate", "CheckOutDate > CheckInDate");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AmenityRoomType_RoomTypesRoomTypeId",
